...
This is where additional shortcuts can be supplied to be dynamically loaded at run time. This works in the following way (top down):
    ...
    1. Callbacks will be passed the instance of IK_ShortcutManager at run time, giving callbacks access to all methods and properties of the IK_ShortcutManager instance. Callbacks can not
    contain blocking behaviour, however a workaround is provided below under limitations.
